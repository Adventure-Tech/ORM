...
test('Can filter within loaded relations', function () {
    ...
    DB::table('posts')->insert([
        ...
        ['id' => 2, 'title' => 'Other Title', 'content' => 'Content', 'number' => 'ONE', 'author' => $authorId, 'deleted_at' => null],
        ['id' => 3, 'title' => 'Title', 'content' => 'Content', 'number' => 'ONE', 'author' => $authorId, 'deleted' => now()],
     ]);
...
test('Can filter into loaded relations', function () {
    $authorId = DB::table('users')->insertGetId(['name' => 'Name']);
    DB::table('posts')->insert([
        ['id' => 1, 'title' => 'Other Title', 'content' => 'Content', 'number' => 'ONE', 'author' => $authorId, 'deleted_at' => null],
    ]);
...
test('Can filter across relations', function () {
    ...
    DB::table('posts')->insert([
        ['id' => 1, 'title' => 'FOO', 'content' => 'Content', 'number' => 'ONE', 'author' => $authorId, 'deleted_at' => null],
        ['id' => 2, 'title' => 'BAR', 'content' => 'Content', 'number' => 'ONE', 'author' => $authorId, 'deleted_at' => null],
    ]);
    $user = Repository::new(User::class)
        ->with('posts', function (Repository $repository) {
